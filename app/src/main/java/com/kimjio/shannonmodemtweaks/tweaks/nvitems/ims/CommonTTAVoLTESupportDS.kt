...
@Parcelize
class CommonTTAVoLTESupportDS : NvItemTweak(), Parcelable {
    @IgnoredOnParcel
    override val name = "Common TTA-VoLTE Support (SIM 2)"

    @IgnoredOnParcel
    override val nameResId = R.string.common_sim_2_tta_volte_support
